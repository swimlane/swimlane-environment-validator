...
def print_table(checks):
    ...
    if config.arguments.verify_lb and verify_load_balancer.verify_dns_resolution(config.arguments.lb_fqdn):
        ...
        #     "fort-kickass.swimlane.io:443": {
        #         "dns-resolution": "192.168.1.13",
        #         "message": "fort-kickass.swimlane.io:443 refused the connection..",
        #         "result": "Failed"
        #     },
        #     "fort-kickass.swimlane.io:6443": {
        #         "dns-resolution": "192.168.1.13",
        #         "result": "Passed",
        #         "status_code": 200
        #     },
        #     "fort-kickass.swimlane.io:8800": {
        #         "dns-resolution": "192.168.1.13",
        #         "result": "Passed",
        #         "status_code": 200
        #     }
